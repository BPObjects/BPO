...
function banner(mkTxt, mkCta, connexion){
  ...
  const rendre = () => {
    ...
    let h = mkTxt()+' &nbsp;<a href="compte.html" style="color:#1a1d23;text-decoration:underline;">'+cta+'</a>';
    /* v7 : seconde issue pour un abonné dont la session est repassée anonyme. */
    if(connexion) h += ' &nbsp;·&nbsp; <a href="compte.html" style="color:#1a1d23;text-decoration:underline;">'+AT("J’ai déjà un compte — me connecter")+'</a>';
    b.innerHTML = h;
  };
  rendre();
